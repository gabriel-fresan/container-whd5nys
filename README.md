...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-whd5nys.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-whd5nys.containers.anotherwebservice.com/
...
```
git clone git@github.com:gabriel-fresan/container-whd5nys.git
cd container-whd5nys
```
...
```
docker attach container-whd5nys
```
